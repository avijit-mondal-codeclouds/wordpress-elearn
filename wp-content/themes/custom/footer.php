        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i><?php the_field('office', 45); ?></p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i><?php the_field('mobile', 45); ?></p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i><?php the_field('email', 45); ?></p>
                    <div class="d-flex pt-2">
                        <a class="btn btn-outline-light btn-social" href="<?php the_field('x', 45); ?>"><i class="fab fa-twitter"></i></a>
                        <a class="btn btn-outline-light btn-social" href="<?php the_field('fb', 45); ?>"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-outline-light btn-social" href="<?php the_field('youtube', 45); ?>"><i class="fab fa-youtube"></i></a>
                        <a class="btn btn-outline-light btn-social" href="<?php the_field('linkedin', 45); ?>"><i class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
